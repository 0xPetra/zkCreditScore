...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  console.log("🚀 ~ file: axiom.ts:78 ~ handler ~ address:", address)
  ...
  const test = {
    ...
    queryId: BigInt(66966676587627506390515603527468953886054461497745819784183473907733311885447), // eslint-disable-line
  ...
  const transaction = `https://explorer.axiom.xyz/v2/goerli/mock/query/${queryId}`
  console.log(
    "View your Query on Axiom Explorer:",
    transaction,
  );
  res.status(200).json({ message: 'Operation successful', data: { transaction, } });
} catch (error) {
  console.log("🚀 ~ file: axiom.ts:133 ~ handler ~ error:", error)
